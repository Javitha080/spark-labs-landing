...
export const ThemeToggle = () => {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="relative rounded-full w-12 h-12 bg-muted/50 hover:bg-muted border border-border/50 hover:border-primary/30 transition-all duration-300 overflow-hidden"
