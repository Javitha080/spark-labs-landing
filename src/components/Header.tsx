                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <ArrowRight
                            className={`size-4 transition-all ${isActive ? "text-primary translate-x-0" : "text-muted-foreground/40 -translate-x-1 group-hover:translate-x-0 group-hover:text-foreground/70"
                              }`}
                          />
                        </button>
                      </m.div>
                    ...
                    return (
                      ...
                      >
                        <Link
                          ...
                          className={`group w-full flex items-center gap-3 px-3 py-3 rounded-2xl text-left transition-all duration-200 ${item.active
                              ? "bg-primary/10 text-primary"
                              : "text-foreground/80 hover:bg-muted/60 hover:text-foreground active:scale-[0.98]"
                            }`}
                        >
                          <span
                            className={`flex items-center justify-center size-9 rounded-xl transition-all ${item.active
                                ? "bg-primary text-primary-foreground shadow-lg shadow-primary/30"
                                : "bg-muted/60 text-muted-foreground group-hover:bg-primary/15 group-hover:text-primary"
                              }`}
                          >
                          ...
                          <ArrowRight
                            className={`size-4 transition-all ${item.active ? "text-primary" : "text-muted-foreground/40 -translate-x-1 group-hover:translate-x-0 group-hover:text-foreground/70"
                              }`}
                          />
                        </Link>
                      </m.div>
