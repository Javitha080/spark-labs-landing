...
const LeaderCard = ({ leader, index }: { leader: TeamMember; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-20 -right-20 size-40 bg-gradient-to-br from-primary/20 to-secondary/20 blob-shape opacity-50" />
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full">
          ...
          {leader.linkedin_url && (
            ...
            >
              <Linkedin className="size-4 group-hover/btn:animate-pulse" />
              LinkedIn
            </Button>
          )}
        </div>
      ...
      {/* Corner decoration */}
      <div className="absolute bottom-0 left-0 size-24 bg-gradient-to-tr from-accent/10 to-transparent rounded-tr-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
    </div>
  );
};
...
const Team = () => {
  ...
  return (
    <section id="team" className="section-padding relative overflow-hidden">
      ...
      <div className="absolute top-0 left-10 size-96 bg-accent/5 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 right-10 size-80 bg-primary/5 rounded-full blur-3xl -z-10" />
