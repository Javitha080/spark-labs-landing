...
const InputOTPGroup = ({ className, ref, ...props }: React.ComponentPropsWithoutRef<"div"> & { ref?: React.Ref<React.ElementRef<"div">> }) => <div ref={ref} className={cn("flex items-center", className)} {...props} />;
