    ...
    <>
      ...
      <main className="min-h-screen bg-background flex items-center justify-center py-24 px-4">
        <div className="absolute top-0 left-0 size-full overflow-hidden pointer-events-none -z-10">
          <div className="absolute top-20 right-20 size-96 bg-amber-500/5 rounded-full blur-3xl" />
          <div className="absolute bottom-20 left-20 size-80 bg-primary/5 rounded-full blur-3xl" />
        </div>

        <Card className="w-full max-w-md border-amber-500/20 shadow-2xl shadow-amber-500/5 backdrop-blur-sm">
          <CardHeader className="text-center pb-2">
            <div className="size-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-amber-500/20">
